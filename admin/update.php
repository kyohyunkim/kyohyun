...
<body>
    ...
    <form class="grades" action="update-ok.php" method="post" enctype="multipart/form-data">
        <table>
            <h1>PORTFOLIO</h1>
            <tr>
                <th>제목</th>
            ...
            <tr>
                <th>PC 타입</th>
                <td>
                    <input type="text" name="pctype" 
                    value="<?php echo $row['pctype']?>">
            </td>
            </tr>
            <tr>
                <th>썸네일</th>
            ...
            <tr>
                <th>상세설명</th>
                <td class="con">
                    <textarea type="contents" name="contents" id ="ir1">
